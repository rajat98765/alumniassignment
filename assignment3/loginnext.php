...
<h1>Hey What's Up <?php echo "$username"?>!!!<br/><br/>

Upload your picture here
<form  action="saveimage.php" enctype="multipart/form-data" method="post">
<table id="yo" style="border-collapse: collapse; font: 12px Tahoma;" border="1" cellspacing="5" cellpadding="5">
<tbody><tr>
<td>
...
<br/><br/>Wanna Chat With Someone?</h1><br/>
